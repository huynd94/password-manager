...
export const GlobeAltIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 0 0 8.716-6.747M12 21a9.004 9.004 0 0 1-8.716-6.747M12 21c1.354 0 2.662-.313 3.86-1.025M12 21c-1.354 0-2.662-.313-3.86-1.025M12 3a9.004 9.004 0 0 0-8.716 6.747M12 3a9.004 9.004 0 0 1 8.716 6.747M12 3c-1.354 0-2.662.313-3.86 1.025M12 3c1.354 0 2.662.313 3.86 1.025M18.75 9.75h-13.5M18.75 14.25h-13.5" />
  </svg>
);
